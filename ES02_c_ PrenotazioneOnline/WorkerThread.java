...
public class WorkerThread extends Thread{
	...
	WorkerThread(String threadName , Socket inSocket, int ClientNo ,  Reservation r) {
		super(threadName);
		sock = inSocket;
		clientNo = ClientNo;
		reservations=r;
	...
	public void run() {
		try {
			...
			while (!cMsg.equals("End")) {
				...
				switch (cMsgArr[0]) {	                         
					case "Info":  
						sMsg=reservations.getReservations();	//stampo la funzione getReservations
						break;

					case "Prenotazione":	//gestisco la prenotazione chiamando setReservation oppure stmpando un messaggio di errore
					...
					case "Help":	//illustro i comandi disponibili
